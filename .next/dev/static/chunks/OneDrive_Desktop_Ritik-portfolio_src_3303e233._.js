...
function Hero({ onOpenContact }) {
    ...
    const [time, setTime] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$Ritik$2d$portfolio$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "Hero.useState": ()=>new Date().toLocaleTimeString([], {
                hour: '2-digit',
                minute: '2-digit'
            })
    }["Hero.useState"]);
    const [isClient, setIsClient] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$Ritik$2d$portfolio$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
...
_s(Hero, "5L3jqhC54B5fUCUsnZsNPEhSDEw=", false, function() {
    return [
